<template>
  <h1 class="title">PageHeader 页头</h1>
  ...
  <highlightjs language="javascript" :code="pageHeader.pageHeader1" />
  ...
  <highlightjs language="javascript" :code="pageHeader.pageHeader2" />
...
const configures = [
  { param: 'title', explain: '标题', type: 'string', value: '——', default: '返回' },
  { param: 'content', explain: '内容', type: 'string', value: '——', default: '——' },
  { param: 'icon', explain: 'icon', type: 'string', value: '——', default: 'tyh-ui-direction-left' },
]
const configEvt = [
  { name: 'back', explain: '点击左侧区域触发', param: '——' }
]
