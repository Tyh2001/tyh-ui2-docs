<template>
  ...
  <p>抽屉的基本使用</p>
  <p>title 属性可以配置抽屉的标题</p>
  <p>footer 插槽可以配置操作区内容</p>
  ...
  <highlightjs language="javascript" :code="dialog.dia1" />

  <h3 class="Subtitle">不带头部信息</h3>
  <p>不带有 title 和关闭按钮</p>
  <p>showHeader 属性可以配置不带头部信息</p>
  ...
  <highlightjs language="javascript" :code="dialog.dia2" />

  <h3 class="Subtitle">多层嵌套</h3>
  <p>width 属性可以配置宽度</p>
  <p>top 属性可以配置距离顶部的距离</p>
  ...
  <highlightjs language="javascript" :code="dialog.dia3" />
...
const configures = [
  ...
  { param: 'width', explain: '宽度', type: 'string', value: '——', default: '30%' },
  { param: 'top', explain: '顶部距离', type: 'string', value: '——', default: '15vh' },
  { param: 'title', explain: '标题', type: 'string', value: '——', default: '——' },
  { param: 'appendToBody', explain: '是否镶嵌到 body 上', type: 'boolean', value: '——', default: 'false' },
  { param: 'modal', explain: '是否显示遮罩层', type: 'boolean', value: '——', default: 'true' },
  { param: 'modalClose', explain: '点击遮罩层是否可以关闭', type: 'boolean', value: '——', default: 'true' },
  { param: 'showClose', explain: '是否显示关闭按钮', type: 'boolean', value: '——', default: 'true' },
  { param: 'showHeader', explain: '是否显示头部信息', type: 'boolean', value: '——', default: 'true' },
  { param: 'zIndex', explain: 'z-index 属性', type: 'number', value: '——', default: '3500' },
]
const configEvt = [
  { name: 'open', explain: '打开时的回调', param: '——' },
  { name: 'onOpen', explain: '打开动画结束时的回调', param: '——' },
  { name: 'close', explain: '关闭时的回调', param: '——' },
  { name: 'onClose', explain: '关闭动画结束时的回调', param: '——' },
]
const slotConfig = [
  { name: 'title', explain: '自定义标题' },
  { name: 'footer', explain: '自定义操作区' },
  { name: 'default', explain: '内容' },
]
</script>
