<template>
  ...
  <pre v-highlight><code class="html">{{ text.text1 }}</code></pre>
  ...
  <pre v-highlight><code class="html">{{ text.text2 }}</code></pre>
  ...
  <pre v-highlight><code class="html">{{ text.text3 }}</code></pre>
